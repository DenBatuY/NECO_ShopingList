...
class ShopListNameAdapter(private val listener: Listener) :
    ...
    class ItemHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun setData(shopListNameItem: ShopListNameItem, listener: Listener) {
            ...
            binding.progressBar.max = shopListNameItem.allItemCounter
            binding.progressBar.progress = shopListNameItem.checkedItemCounter
            val colorState=ColorStateList.valueOf(getProgressColorState(shopListNameItem,binding.root.context))
            binding.progressBar.progressTintList=colorState
            val counterText =
                "${shopListNameItem.checkedItemCounter}/${shopListNameItem.allItemCounter}"
        ...
        private fun getProgressColorState(item: ShopListNameItem, context: Context): Int {
            ...
            } else {ContextCompat.getColor(context, R.color.picker_red)}
        }
    }
